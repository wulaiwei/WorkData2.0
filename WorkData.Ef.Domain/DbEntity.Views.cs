...
[assembly: DbMappingViewCacheTypeAttribute(
    ...
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets107a58fe9590b41a3c196e6521a309ec0c3bf30c886155417b94a5c843b4cf36))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets107a58fe9590b41a3c196e6521a309ec0c3bf30c886155417b94a5c843b4cf36 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "107a58fe9590b41a3c196e6521a309ec0c3bf30c886155417b94a5c843b4cf36"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "DbEntity.Users")
            {
                return GetView7();
            }

            if (extentName == "DbEntity.Roles")
            {
                return GetView8();
            }
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for DbEntity.Users.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for DbEntity.Roles.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        SELECT -- Constructing Role_Resources_Source
            CreateRef(DbEntity.Roles, row(T2.[Role_Resources.Role_Resources_Source.RoleId]), [WorkData.EF.Domain.Role]) AS [Role_Resources.Role_Resources_Source], 
    ...
    FROM (
        SELECT -- Constructing User_Roles_Source
            CreateRef(DbEntity.Users, row(T2.[User_Roles.User_Roles_Source.UserId]), [WorkData.EF.Domain.User]) AS [User_Roles.User_Roles_Source], 
            T2.[User_Roles.User_Roles_Target]
        FROM (
            SELECT -- Constructing User_Roles_Target
                T1.[User_Roles.User_Roles_Source.UserId], 
                CreateRef(DbEntity.Roles, row(T1.[User_Roles.User_Roles_Target.RoleId]), [WorkData.EF.Domain.Role]) AS [User_Roles.User_Roles_Target]
            FROM (
                SELECT 
