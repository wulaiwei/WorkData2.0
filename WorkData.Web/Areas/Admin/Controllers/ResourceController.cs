...
namespace WorkData.Web.Areas.Admin.Controllers
{
    ...
    public class ResourceController : Controller
    {
        ...
        public ActionResult Save(ResourceDto model)
        {
            ...
            var infoActions = AssemblyHelper.LoadAction("WorkData.Web");
            AuthConfigXmlHelper.UpdateConfig(Api.PhysicsUrl + "/Config/AuthConfig.xml", infoActions);
        ...
        {
            var treeList = _resourceBll.GetSourceTree(false,null);
            return Json(treeList, JsonRequestBehavior.AllowGet);
        }
